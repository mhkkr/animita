...
export default function User() {
  ...
  return (
    <Popover className="relative">
      ...
      >
        <Popover.Panel className="absolute top-10 sm:bottom-full right-0 sm:left-4 sm:right-4 border dark:border-white/25 bg-white dark:bg-black rounded-xl overflow-hidden shadow-xl whitespace-nowrap">
          ...
          {/* <a className="flex items-center p-3 w-full hover:text-red-500 font-bold" href={`https://annict.com/@${data?.user?.id}`} target="_blank" rel="noopener noreferrer">
            <Icons id="open_in_new" type="link" className="mr-1.5 text-lg" />
            ユーザーページ
          </a> */}
        </Popover.Panel>
      </Transition>
