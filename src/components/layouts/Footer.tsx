  ...
  return (
    <footer className={`${className} text-xs dark:text-white/70`}>
      <ul className="flex lg:block flex-col items-end">
        ...
        <li className="mt-1 pl-[1em] indent-[-1em]">※ソースコードは <a className="text-sky-600 hover:underline" href="https://github.com/mhkkr/watch.kakera.dev" target="_blank" rel="noopener noreferrer">GitHub</a> で公開しています。</li>
      </ul>
