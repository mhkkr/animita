...
const updates = [
  {
    date: '2025/11/22 (土)',
    comments: [
      '記録画面にエピソードの前後リンクを付けました。',
      '記録画面がブラウザ履歴に対応しました。',
      '見てる・見たいのアニメ一覧で未視聴数を表示するようにしました。',
      '見た・一時中断・視聴中止のアニメ一覧は簡素な表示に変更しました。'
    ]
  },
  {
    date: '2025/11/19 (水)',
    comments: [
      '各種ライブラリを最新のものに変更しましたVer3。',
      '各アニメ詳細のエピソードにて、表記話数が前期を引き継ぐ場合、今期の話数を表記するようにしました。'
    ]
  },
  {
    date: '2024/11/4 (月)',
