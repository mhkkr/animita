...
export type LibraryEntriesQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', libraryEntries?: { __typename?: 'LibraryEntryConnection', nodes?: Array<{ __typename?: 'LibraryEntry', id: string, note: string, status?: { __typename?: 'Status', state: StatusState } | null, work: { __typename?: 'Work', annictId: number, malAnimeId?: string | null, title: string, image?: { __typename?: 'WorkImage', facebookOgImageUrl?: string | null, copyright?: string | null } | null, episodes?: { __typename?: 'EpisodeConnection', nodes?: Array<{ __typename?: 'Episode', annictId: number, sortNumber: number, viewerDidTrack: boolean } | null> | null } | null, programs?: { __typename?: 'ProgramConnection', nodes?: Array<{ __typename?: 'Program', startedAt: any, channel: { __typename?: 'Channel', annictId: number } } | null> | null } | null }, nextProgram?: { __typename?: 'Program', startedAt: any, channel: { __typename?: 'Channel', annictId: number, name: string }, episode: { __typename?: 'Episode', annictId: number, number?: number | null, numberText?: string | null, title?: string | null } } | null } | null> | null } | null } | null };

export type LibraryEntriesSimpleQueryVariables = Exact<{
  states?: InputMaybe<Array<StatusState> | StatusState>;
  seasons?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
}>;


export type LibraryEntriesSimpleQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', libraryEntries?: { __typename?: 'LibraryEntryConnection', nodes?: Array<{ __typename?: 'LibraryEntry', work: { __typename?: 'Work', id: string, annictId: number, malAnimeId?: string | null, title: string, image?: { __typename?: 'WorkImage', facebookOgImageUrl?: string | null, copyright?: string | null } | null } } | null> | null } | null } | null };
...
export type ViewerRecordsQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', records?: { __typename?: 'RecordConnection', edges?: Array<{ __typename?: 'RecordEdge', node?: { __typename?: 'Record', id: string, annictId: number, ratingState?: RatingState | null, episode: { __typename?: 'Episode', title?: string | null, number?: number | null, annictId: number, work: { __typename?: 'Work', title: string, annictId: number } } } | null } | null> | null } | null } | null };

export type ViewerUserQueryVariables = Exact<{ [key: string]: never; }>;


export type ViewerUserQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', id: string, annictId: number, username: string, name: string, avatarUrl?: string | null, description: string, url?: string | null, createdAt: any, notificationsCount?: number | null, followingsCount: number, followersCount: number, recordsCount: number, wannaWatchCount: number, watchingCount: number, watchedCount: number, onHoldCount: number, stopWatchingCount: number } | null };
...
export const LibraryEntriesSimpleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"libraryEntriesSimple"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"states"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"StatusState"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seasons"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"viewer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"libraryEntries"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"states"},"value":{"kind":"Variable","name":{"kind":"Name","value":"states"}}},{"kind":"Argument","name":{"kind":"Name","value":"seasons"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seasons"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"annictId"}},{"kind":"Field","name":{"kind":"Name","value":"malAnimeId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"facebookOgImageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"copyright"}}]}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<LibraryEntriesSimpleQuery, LibraryEntriesSimpleQueryVariables>;
