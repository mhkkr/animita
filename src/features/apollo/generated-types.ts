...
export type ViewerUserQuery = { __typename?: 'Query', viewer?: { __typename?: 'User', annictId: number, username: string, name: string, avatarUrl?: string | null, description: string, url?: string | null, recordsCount: number, followingsCount: number, followersCount: number, wannaWatchCount: number, watchingCount: number, watchedCount: number, onHoldCount: number, stopWatchingCount: number, createdAt: any, notificationsCount?: number | null } | null };
